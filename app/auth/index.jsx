...
const Login = () => {
    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: "#fff", position: "relative", paddingHorizontal: 20 }}>
            ...
            <TextInput placeholderTextColor={"#C9C5B4"} placeholder={activeTab=='email'?'e.g. example@gmail.com':'e.g. +12********'} style={{ backgroundColor: "#FCFCFC", height: 50, width: "100%", marginTop: 20, borderRadius: 10, paddingHorizontal: 20 }} />
